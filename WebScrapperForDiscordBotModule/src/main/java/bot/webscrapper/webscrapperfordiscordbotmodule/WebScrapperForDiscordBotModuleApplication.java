...
import bot.webscrapper.webscrapperfordiscordbotmodule.webcrawlerlayer.WebCrawlerExecutionManager;
...
public class WebScrapperForDiscordBotModuleApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        WebCrawlerExecutionManager webCrawlerExecutionManager = new WebCrawlerExecutionManager();
    }
}
